  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center px-4">
        <div className="relative bg-white w-full max-w-lg p-6 rounded-2xl shadow-2xl border border-green-100 animate-fadeIn">
          ...
          {selectedItem.type === "Video" && selectedItem.video_url && (
            <a
              ...
              className="inline-flex items-center gap-2 bg-islamic-gradient text-white px-5 py-2 rounded-full hover:opacity-90 transition"
            >
