        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Tentang <span className="text-gradient">Al-Hidayah</span>
              </h2>
              <div className="w-20 h-1 bg-islamic-gradient rounded"></div>
            </div>

            <p className="text-lg text-gray-600 leading-relaxed">
              Pondok Pesantren Al-Hidayah didirikan dengan visi untuk mencetak generasi muslim 
          ...
          <div className="relative">
            <div className="bg-islamic-gradient rounded-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
              <img
                src="https://images.unsplash.com/photo-1492321936769-b49830bc1d1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2671&q=80"
